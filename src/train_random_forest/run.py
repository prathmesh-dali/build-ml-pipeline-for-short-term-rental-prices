...
def go(args):
    ...
    # Use run.use_artifact(...).file() to get the train
    # and validation artifact (args.trainval_artifact)
    ...
    # y_train
    sk_pipe.fit(X=X_train, y=y_train)
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Randomforest pipeline",
        metadata=rf_config
    )
