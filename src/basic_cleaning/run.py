...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact",
        type=str,
        help="Complete path of the input artifact",
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact",
        type=str,
        help="Name of the output artifact to create on W&B",
        required=True
    )
    ...
    parser.add_argument(
        "--output_type",
        type=str,
        help="Type of the output artifact to create on W&B",
        required=True
    )
    ...
    parser.add_argument(
        "--output_description",
        type=str,
        help="Description about output artifact to save on the W&B",
        required=True
    )
